...
- [misskey-dev/misskey](https://github.com/misskey-dev/misskey) ([13.2.5](https://github.com/misskey-dev/misskey/releases/tag/13.2.5), 3 days ago) - 🌎 An interplanetary microblogging platform 🚀
- [vector-im/element-android](https://github.com/vector-im/element-android) ([v1.5.22](https://github.com/vector-im/element-android/releases/tag/v1.5.22), 5 days ago) - A glossy Matrix collaboration client for Android.
...
- [Add basic vehicle sidebar](https://github.com/tlm-solutions/windshield/pull/23) on [tlm-solutions/windshield](https://github.com/tlm-solutions/windshield) (3 days ago)
...
- [djc/askama](https://github.com/djc/askama) - Type-safe, compiled Jinja-like templates for Rust (4 days ago)
