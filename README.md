...
- [vector-im/element-android](https://github.com/vector-im/element-android) ([v1.4.28](https://github.com/vector-im/element-android/releases/tag/v1.4.28), 2 days ago) - A glossy Matrix collaboration client for Android.
- [MarcelCoding/bszet-vplan](https://github.com/MarcelCoding/bszet-vplan) ([v1.2.3](https://github.com/MarcelCoding/bszet-vplan/releases/tag/v1.2.3), 4 days ago) - Automatically monitors bszet dd timetable for changes and sends notifications.
...
- [houqp/leptess](https://github.com/houqp/leptess) - Productive and safe Rust binding for leptonica and tesseract (4 days ago)
- [elizagamedev/vobsubocr](https://github.com/elizagamedev/vobsubocr) - Blazingly fast and accurate DVD VobSub to SRT subtitle conversion (4 days ago)
...
- [NLnetLabs/krill](https://github.com/NLnetLabs/krill) - RPKI Certificate Authority and Publication Server written in Rust (4 weeks ago)
