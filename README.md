...
- [MarcelCoding/jitsi-openid](https://github.com/MarcelCoding/jitsi-openid) ([v2.0.13](https://github.com/MarcelCoding/jitsi-openid/releases/tag/v2.0.13), 4 weeks ago) - Jitsi OpenID is an authentication adapter that allows Jitsi to authorize users with OpenID Connect.
...
- [Disabled pgadmin upgrade check](https://github.com/NixOS/nixpkgs/pull/279274) on [NixOS/nixpkgs](https://github.com/NixOS/nixpkgs) (1 day ago)
...
- [Updated to nixos 23.11](https://github.com/dd-ix/nix-config/pull/41) on [dd-ix/nix-config](https://github.com/dd-ix/nix-config) (4 weeks ago)
