...
- [vector-im/element-android](https://github.com/vector-im/element-android) ([v1.5.10](https://github.com/vector-im/element-android/releases/tag/v1.5.10), 2 days ago) - A glossy Matrix collaboration client for Android.
- [MarcelCoding/zia](https://github.com/MarcelCoding/zia) ([v0.2.4](https://github.com/MarcelCoding/zia/releases/tag/v0.2.4), 4 days ago) - Proxy udp over websocket, useful to use Wireguard in restricted networks.
...
- [Added statically linked binaries](https://github.com/MarcelCoding/zia/pull/51) on [MarcelCoding/zia](https://github.com/MarcelCoding/zia) (6 days ago)
...
- [vinceliuice/Lavanda-gtk-theme](https://github.com/vinceliuice/Lavanda-gtk-theme) - Lavanda gtk theme for linux desktops (6 days ago)
