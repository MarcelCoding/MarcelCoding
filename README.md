...
- [MarcelCoding/jitsi-openid](https://github.com/MarcelCoding/jitsi-openid) - Jitsi OpenID is an authentication adapter that allows Jitsi to authorize users with OpenID Connect. (3 weeks ago)
...
- [renovatebot/renovate](https://github.com/renovatebot/renovate) ([35.102.0](https://github.com/renovatebot/renovate/releases/tag/35.102.0), 1 day ago) - Universal dependency update tool that fits into your workflows.
- [MarcelCoding/bszet-mind](https://github.com/MarcelCoding/bszet-mind) ([v0.1.8](https://github.com/MarcelCoding/bszet-mind/releases/tag/v0.1.8), 5 days ago) - A tool to monitor STÜBER SYSTEMS&#39; DAVINCI&#39;s HTML exported substitution plan for changes.
- [misskey-dev/misskey](https://github.com/misskey-dev/misskey) ([13.13.0-beta.3](https://github.com/misskey-dev/misskey/releases/tag/13.13.0-beta.3), 6 days ago) - 🌎 An interplanetary microblogging platform 🚀
...
- [Fixed swagger](https://github.com/tlm-solutions/datacare/pull/28) on [tlm-solutions/datacare](https://github.com/tlm-solutions/datacare) (3 weeks ago)
