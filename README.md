...
- [misskey-dev/misskey](https://github.com/misskey-dev/misskey) ([13.9.1](https://github.com/misskey-dev/misskey/releases/tag/13.9.1), 1 day ago) - 🌎 An interplanetary microblogging platform 🚀
...
- [MarcelCoding/jitsi-openid](https://github.com/MarcelCoding/jitsi-openid) ([v2.0.1](https://github.com/MarcelCoding/jitsi-openid/releases/tag/v2.0.1), 3 weeks ago) - Jitsi OpenID is an authentication adapter that allows Jitsi to authorize users with OpenID Connect.
...
- [Replace bash process with java process instead of creating a sub process](https://github.com/dbeaver/cloudbeaver/pull/1452) on [dbeaver/cloudbeaver](https://github.com/dbeaver/cloudbeaver) (4 weeks ago)
