...
- [MarcelCoding/cryptic-grpc](https://github.com/MarcelCoding/cryptic-grpc) (5 days ago)
...
- [MarcelCoding/luna](https://github.com/MarcelCoding/luna) ([v1.0.7](https://github.com/MarcelCoding/luna/releases/tag/v1.0.7), 1 day ago)
- [vector-im/element-android](https://github.com/vector-im/element-android) ([v1.4.34](https://github.com/vector-im/element-android/releases/tag/v1.4.34), 6 days ago) - A glossy Matrix collaboration client for Android.
...
- [gradle/gradle-build-action](https://github.com/gradle/gradle-build-action) - Execute a Gradle Build in your Github Actions workflow (2 days ago)
- [serialhex/nano-highlight](https://github.com/serialhex/nano-highlight) - a spiffy collection of nano syntax highlighting files (3 days ago)
- [stedolan/jq](https://github.com/stedolan/jq) - Command-line JSON processor (6 days ago)
