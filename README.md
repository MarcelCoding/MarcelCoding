...
- [vector-im/element-android](https://github.com/vector-im/element-android) ([v1.4.24](https://github.com/vector-im/element-android/releases/tag/v1.4.24), 1 day ago) - A glossy Matrix collaboration client for Android.
...
- [Updated jitsi-openid to 2.0.0](https://github.com/secshellnet/docs/pull/11) on [secshellnet/docs](https://github.com/secshellnet/docs) (5 days ago)
...
- [NLnetLabs/krill](https://github.com/NLnetLabs/krill) - RPKI Certificate Authority and Publication Server written in Rust (6 days ago)
