...
- [misskey-dev/misskey](https://github.com/misskey-dev/misskey) ([13.11.1](https://github.com/misskey-dev/misskey/releases/tag/13.11.1), 2 days ago) - 🌎 An interplanetary microblogging platform 🚀
- [MarcelCoding/jitsi-openid](https://github.com/MarcelCoding/jitsi-openid) ([v2.0.2](https://github.com/MarcelCoding/jitsi-openid/releases/tag/v2.0.2), 6 days ago) - Jitsi OpenID is an authentication adapter that allows Jitsi to authorize users with OpenID Connect.
- [vector-im/element-android](https://github.com/vector-im/element-android) ([v1.5.30](https://github.com/vector-im/element-android/releases/tag/v1.5.30), 6 days ago) - A glossy Matrix collaboration client for Android.
